...
#include "../ProjetoFinal/include/Qt/secondWindow.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_secondWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 43, 5)
    ...
    "secondWindow\0on_shadowSlider_valueChanged\0"
    "\0value\0"
};
...
void secondWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_shadowSlider_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject secondWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_secondWindow.data,
      qt_meta_data_secondWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_secondWindow.stringdata))
