...
#include <stdlib.h>
#include <math.h>
#include "../headers/matrix-class.h"
...
Matrix *sum(Matrix *A,Matrix *B)
	...
	if(A->rows == B->rows && A->columns == B->columns && A && B)
		...
		char msg[50];
		sprintf(msg, "sum Matrizes não tem mesmas dimensões!\n Ou então\
