...
public class Conta
	{
		...
		//----------------CONSTRUTORES----------------------
		//--------------------------------------------------
		public Conta(String new_number, String new_dono)
			{
		...
		public Conta(String new_number, String new_dono, double saldo_0)
			{
				setNumber(new_number);
				setDono(new_dono);
				setSaldo(saldo_0);
		...
		*/
			{
				System.out.println("CPF do Cliente :\t" + getDono());
		...
		*/
		...
		public void setDono(String new_dono)
			{
				donoCpf = new_dono;
				return;
			}
